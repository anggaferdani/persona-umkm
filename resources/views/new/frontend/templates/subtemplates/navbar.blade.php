<nav class="navbar navbar-expand-lg w-100" data-bs-theme="dark">
  <div class="container">
    ...
    <div class="d-flex d-sm-flex d-md-flex d-lg-none gap-2">
      <a href="" class="btn rounded-circle" style="aspect-ratio: 1 / 1; background: linear-gradient(to right, #8C1AE5, #EC5AEF); border: none; color: white;"><i class="fa-solid fa-clock-rotate-left"></i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav m-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" style="color: #ffffff !important;" href="#">PERSONA UMKM</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="color: #ffffff !important;" href="#">AI <span class="badge bg-white text-dark">NEW</span></a>
        </li>
      </ul>
      <div class="d-none d-sm-none d-md-none d-lg-flex gap-2">
        <a type="button" class="btn rounded-pill px-3" style="background: linear-gradient(to right, #8C1AE5, #EC5AEF); border: none; color: white;"><i class="fa-solid fa-clock-rotate-left"></i> HISTORY</a>
